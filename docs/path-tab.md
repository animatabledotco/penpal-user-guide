...
#### <img src="/img/paths - center.svg" alt="" data-size="line"> Center

Center the path in the composition, layer or shape group, depending on which Space you have active.&#x20;

#### <img src="/img/paths - centerV.svg" alt="" data-size="line"> Center vertically,  <img src="/img/paths - centerH.svg" alt="" data-size="line"> Center horizontally

Vertically or horizontally center the path, as above.

#### <img src="/img/paths - flipV.svg" alt="" data-size="line"> Flip vertically, <img src="/img/paths - flipH.svg" alt="" data-size="line"> Flip horizontally

Flip the path top-to-bottom or left-to-right, around its  center.

#### <img src="/img/paths - flipT.svg" alt="" data-size="line"> Flip up, <img src="/img/paths - flipB.svg" alt="" data-size="line"> Flip down,  <img src="/img/paths - flipR.svg" alt="" data-size="line"> Flip right,  <img src="/img/paths - flipL.svg" alt="" data-size="line"> Flip left

Flip the path around the top, bottom, right or left edge of its  bounding box.

#### <img src="/img/paths - reverse.svg" alt="" data-size="line"> Reverse
...
#### <img src="/img/paths - open.svg" alt="" data-size="line"> Toggle open
...
#### <img src="/img/paths - simplify.svg" alt="" data-size="line"> Simplify
...
#### <img src="/img/paths - join.svg" alt="" data-size="line"> Join
